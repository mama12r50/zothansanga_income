...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" id="applicationStylesheet" href="css/fieldofficer.css"/>
    </head>
    ...
    <body>
		...
		<div id="Home">
		<span><a href="homepage">Home</span>
		</div>
        ...
        <h1 id="list">LIST OF ISSUED APPLICATIONS</h1>
        <style>
...

        {
            ...
            border:1px solid black;
                ...
                @foreach($fieldofficer as $fieldofficer)

                <tr>
                <td>{{$fieldofficer->id}}</td>
                <td><a href="/issued/{{$fieldofficer->id}}">{{$fieldofficer->Application_Number}}</a></td>
                <td>{{$fieldofficer->applicant_name}}</td>
                <td>{{$fieldofficer->created_at}}</td>
                <td>{{$fieldofficer->date_of_birth}}</td>
                <td>{{$fieldofficer->contact_number}}</td>
                <td>{{$fieldofficer->circle_officer_status}}</td>
                </tr>
	...
	<span>Field Officer Login</span><br>
	</div>
