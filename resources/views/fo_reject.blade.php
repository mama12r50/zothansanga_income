...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" id="applicationStylesheet" href="css/submitted.css"/>
    </head>
...
You have REJECTED the application form successfully!!!
	...
	<span>Field Officer Login</span><br>
        ...
        <a href="/homepage" class="home">Home</a>
