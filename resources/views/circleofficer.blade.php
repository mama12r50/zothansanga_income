...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" id="applicationStylesheet" href="css/circleofficer.css"/>
    </head>
    ...
    <body>
		...
		<div id="Officers_Login">
			<span>Circle Officer Login</a></span>
		</div>
        ...
        <h1 id="list">LIST OF FORWARDED APPLICATIONS</h1>
        <style>
...

        {
            ...
            border:1px solid black;
                ...
                @foreach($circleofficer as $circleofficer)

                <tr>
                <td>{{$circleofficer->id}}</td>
                <td><a href="/forwarded/{{$circleofficer->id}}">{{$circleofficer->Application_Number}}</a></td>
                <td>{{$circleofficer->applicant_name}}</td>
                <td>{{$circleofficer->created_at}}</td>
                <td>{{$circleofficer->date_of_birth}}</td>
                <td>{{$circleofficer->contact_number}}</td>
                <td>{{$circleofficer->forwarder_status}}</td>
                </tr>
