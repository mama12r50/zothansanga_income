...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" id="issuedstylesheet" href="css/.css"/>
    </head>
    ...
    <h1 id="details">FORM DETAILS</h1>
        <fieldset>
            ...
            <table>
                ...
                <td>{{$issueds->Application_Number}}</td>
                </tr>
                <tr>
                <td>Applicant Name</td>
                <td>{{$issueds->applicant_name}}</td>
                </tr>
                <tr>
                <td>Date of Birth</td>
                <td>{{$issueds->date_of_birth}}</td>
                </tr>
                <tr>
                <td>Gender</td>
                <td>{{$issueds->gender}}</td>
                </tr>
                <tr>
                <td>Email</td>
                <td>{{$issueds->email}}</td>
                ...
                <td>{{$issueds->contact_number}}</td>
                </tr>
                <tr>
                <td>Relationship</td>
                <td>{{$issueds->relationship}}</td>
                </tr>
                <tr>
                <td>Education</td>
                <td>{{$issueds->education}}</td>
                </tr>
                <tr>
                <td>Religion</td>
                <td>{{$issueds->religion}}</td>
                </tr>
                <tr>
                <td>Occupation</td>
                <td>{{$issueds->occupation}}</td>
                </tr>
                <tr>
                <td>Annual Income</td>
                <td>{{$issueds->annual_income}}</td>
                </tr>
                <tr>
                <td>Father's Income</td>
                <td>{{$issueds->father_income}}</td>
                </tr>
                <tr>
                <td>Mother's Income</td>
                <td>{{$issueds->mother_income}}</td>
                </tr>
                <tr>
                <td>Mother's Occupation</td>
                <td>{{$issueds->mother_occupation}}</td>
                </tr>
                <tr>
                <td>Other Occupatioin</td>
                <td>{{$issueds->other_occupation}}</td>
                </tr>
                <tr>
                <td>Other Income</td>
                <td>{{$issueds->other_income}}</td>
                </tr>
            </table>
        </fieldset>
        <fieldset>
            ...
            <table>
                ...
                <tr>
                <td>House Number</td>
                <td>{{$issueds->house_number}}</td>
                </tr>
                <tr>
                <td>Locality</td>
                <td>{{$issueds->locality}}</td>
                </tr>
                <tr>
                <td>Sub Locality</td>
                <td>{{$issueds->sub_locality}}</td>
                </tr>
                <tr>
                <td>Location</td>
                <td>{{$issueds->location}}</td>
                </tr>
                <tr>
                <td>Sub District</td>
                <td>{{$issueds->sub_dictrict}}</td>
                </tr>
                <tr>
                <td>District</td>
                <td>{{$issueds->district}}</td>
                </tr>
                <tr>
                <td>State</td>
                <td>{{$issueds->state}}</td>
                ...
                <tr>
                <td>Pincode</td>
                <td>{{$issueds->pincode}}</td>
                </tr>
                <tr>
                <td>Country</td>
                <td>{{$issueds->country}}</td>
                </tr>
                <tr>
                <td>Police Station</td>
                <td>{{$issueds->police_station}}</td>
                </tr>
            </table>
        </fieldset>
        <fieldset>
        <legend>Permanent Address</legend>
            ...
            <table>
                <tr>
                <td>House Number</td>
                <td>{{$issueds->house_number1}}</td>
                </tr>
                <tr>
                <td>Locality</td>
                <td>{{$issueds->locality1}}</td>
                </tr>
                <tr>
                <td>Sub Locality</td>
                <td>{{$issueds->sub_locality1}}</td>
                </tr>
                <tr>
                <td>Location</td>
                <td>{{$issueds->location1}}</td>
                </tr>
                <tr>
                <td>Sub District</td>
                <td>{{$issueds->sub_dictrict1}}</td>
                </tr>
                <tr>
                <td>District</td>
                <td>{{$issueds->district1}}</td>
                </tr>
                <tr>
                <td>State</td>
                <td>{{$issueds->state1}}</td>
                </tr>
                <tr>
                <td>Pincode</td>
                <td>{{$issueds->pincode1}}</td>
                </tr>
                <tr>
                <td>Country</td>
                <td>{{$issueds->country1}}</td>
                </tr>
                <tr>
                <td>Police Station</td>
                <td>{{$issueds->police_station1}}</td>
                </tr>
            </table>
        </fieldset>
            <table>
                ...
                <td>{{$issueds->remark2}}</td>
                </tr>
                <tr>
                <td>Note Sheet File Number</td>
                <td>{{$issueds->Note_Sheet_Number}}</td>
                </tr>
            <form>
                <tr>
                <td>Note Sheet: <input type="text" name="Note_Sheet"></td>
                <td>{{$issueds->Note_Sheet}}</td>
                </tr>
            </form>
                <tr>
                <td>Remarks/Suggestion/Comments to be enclosed by officer</td>
                <td>{{$issueds->remark3}}</td>
                </tr>
            </table>
</div>
                <form action="/fieldofficer/{{$issueds->id}}/check" method="POST">
